package com.ca.mfaas.tmimsivtzoweapi.api.v1;
...
public class IvtDisplay {
    ...
    public IvtDisplay(String lastname) throws ResourceException, UnsupportedEncodingException {
		...
		//ixnSpec.setCommitMode(IMSInteractionSpec.COMMIT_THEN_SEND); 
	    ...
	    // IVTNO/IVTCM transaction accepts 59 bytes long input message
